    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        signUpAsSenderBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                @NonNull NavDirections action = signUpFragmentDirections.actionFragmentSignUpToFragmentSignUpAsSender();
        ...
        signUpAsDriverBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                @NonNull NavDirections action = signUpFragmentDirections.actionFragmentSignUpToFragmentSignUpAsDriver();
                Navigation.findNavController(v).navigate(action);
            }
        });
        return view;
